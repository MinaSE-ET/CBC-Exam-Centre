...
class ExamAdmin(admin.ModelAdmin):
    list_display = [
        ...
        'total_marks_display', 'passing_marks_display', 'start_date', 'end_date'
    ]
...
class CertificationAdmin(admin.ModelAdmin):
    list_display = ['certificate_id', 'student', 'exam', 'percentage_score', 'get_grade', 'issued_date', 'is_valid']
    list_filter = ['is_valid', 'issued_date', 'exam__course']
    search_fields = ['certificate_id', 'student__username', 'student__first_name', 'student__last_name', 'exam__title']

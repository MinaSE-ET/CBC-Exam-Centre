...
class ExamForm(forms.ModelForm):
    class Meta:
        model = Exam
        fields = ['title', 'description', 'course', 'duration_minutes', 'status', 'questions', 'assigned_users', 'passing_percentage', 'start_date', 'end_date']
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.fields['passing_percentage'].help_text = 'Set the percentage required to pass (e.g. 60 for 60%)'
